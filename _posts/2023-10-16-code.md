...
# (2.1) Generate N uniform random variates in [0,1) and determine the distribution into class intervals [i/k, (i+1)/k), i = 0,..., k-1.
...
# (2.2) Playing with subintervals and generated variates
...
#  Code
The script for this part can be found in the repository [my_github_page](https://github.com/Cheroberous/Statistic/tree/main/H2/s_j_2/js_h2)
in the "frequencies_class_intervals.html" file
